...
\section{objective}
To extend my research skills and build research contacts through
doing research in a highly innovative U.S.~technology company
...
Reykjavik, Iceland
\hfill{\bf M.Sc., Computer Science, June 2009}
%\begin{outerlist}
...
Reykjavik, Iceland
\hfill{\bf B.Sc., Mathematics, June 2004}
%\begin{outerlist}
...
\begin{innerlist}
\item Design, implementation and maintenance of both in-house and customer
    facing information systems, and their supporting infrastructure.
...
\href{http://www.visir.is/}{\textbf{visir.is}}, Reykjavik, Iceland -- \textit{Web application programmer}
...
\textbf{MotorIs}, 
Reykjavik, Iceland -- \textit{Production assistant}
...
\section{skills}
Languages: Icelandic (native); English, Swedish (fluent); Danish, German (basic)
\\[6pt]
Technical: Advanced programming, programming language design and analysis, security
analysis. Theoretical foundations of computing and program semantics. Discrete
mathematics, logic, algebra. Conducting research (see website for publications).
\\[6pt]
Interests: Sailing, photography, hiking, skiing
